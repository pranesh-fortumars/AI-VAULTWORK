        ...
        <div className="mt-8">
          ...
          <div className="mt-6 grid grid-cols-2 gap-4">
            <button
              ...
              type="button"
              className="flex items-center justify-center w-full px-4 py-3 border border-border rounded-xl bg-card hover:bg-secondary transition-colors text-sm font-medium text-foreground"
            >
